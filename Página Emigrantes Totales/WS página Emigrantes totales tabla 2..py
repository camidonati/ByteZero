...
# URL de la página
url = "https://datosmacro.expansion.com/demografia/migracion/emigracion/argentina?anio=2020#geo0"
...
table = soup.find('table', id='tb2_18868')
...
if table:
    ...
    csv_filename = os.path.join(ruta_completa, 'argentina_emigrantes_totales_tabla2.csv')
